...
class MuxCommand(Command):
    ...
    def parse(self):
        ...
        # sure that self.caller is always the player if possible. We also
        # create  a special property "character" for the puppeted object, if
        # any. This  is convenient for commands defined on the Player only.
        if hasattr(self, "player_caller") and self.player_caller:
            if utils.inherits_from(self.caller,
                ...
                self.caller = self.caller.player
                                     ...
                                     "evennia.players.players.DefaultPlayer"):
